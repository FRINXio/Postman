...
Classic_folders=("Mount" "General information" "Interface" "Interface IP" "ospf/vrf" "static route" "BGP summary" "CDP" "subinterface common" "L2P2P" "L2P2P CRUD" "journal/dry-run" "Unmount")
